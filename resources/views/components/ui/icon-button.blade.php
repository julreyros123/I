...
@php
    $base = 'inline-flex items-center justify-center transition focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed';
    ...
    $variants = [
        ...
        'ghost' => 'border border-gray-300 text-gray-600 hover:bg-gray-100 focus:ring-gray-400 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800',
    ];
